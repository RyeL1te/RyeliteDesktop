...
describe('Window Controls Helper', () => {
    ...
    describe('onClickSend function', () => {
        it('should add click event listener to existing button', () => {
            ...
            expect(mockIpcRenderer.send).toHaveBeenCalledWith('minimize-window')
        })
        ...
        it('should send correct channel on button click', () => {
            ...
            expect(mockIpcRenderer.send).toHaveBeenCalledWith('toggle-maximize-window')
        })
    ...
    describe('Error Scenarios', () => {
        ...
        it('should handle missing electron API', () => {
            ...
            expect(testAccess({ electron: { process: { platform: 'test' } } })).toBe('test')
        })
    })
    ...
    describe('Integration', () => {
        it('should work end-to-end with setupWindowControls', () => {
            ...
            expect(mockIpcRenderer.send).toHaveBeenNthCalledWith(1, 'minimize-window')
            expect(mockIpcRenderer.send).toHaveBeenNthCalledWith(2, 'toggle-maximize-window')
            expect(mockIpcRenderer.send).toHaveBeenNthCalledWith(3, 'close-window')
        })
